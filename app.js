...
//usuwanie działa,
//edytowanie działa,
//trzba jakiś prosty mechanizm sortowania dodać, i bedzie to jako zmiana kolejnści produktów
//walidację danych 
// i gotowe :D
...
window.addEventListener('load', () => {
  ...
  function DisplayProducts() {
    ...
    products.forEach(product => {
      ...
      // EDYCJA PRODUKTU
      //trzeba dodać walidacje tego co przyjmuje się do input
      ...
      deleteButton.addEventListener('click', (e) => {
        //trzeba dodać komunikat czy na pewno chcesz usunąć produkt **************
